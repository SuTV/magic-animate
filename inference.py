...
def main(reference_image_path, motion_sequence_path, seed, steps, guidance_scale, output_path):
    animator = MagicAnimate()

    reference_image = read_image(reference_image_path)
    motion_sequence = read_video(motion_sequence_path)

    animation = animator(reference_image, motion_sequence, seed, steps, guidance_scale, output_path)
    return animation
...
if __name__ == "__main__":
    ...
    parser.add_argument("output_path", help="Path to the result")
